<template>
  <div class="app-container" id="wrapper">
    <div class="module-title">场景营销</div>
        ...
        <div>
          ...
          <el-table class="mb15"
            ...
            <el-table-column
              align="center"
              label="场景类型"
              prop="marketingSceneType"
              :filters="marketingSceneTypes"
              :filter-multiple="false"
              filter-placement="bottom-end"
              :filter-method="handleMarketingSceneTypeFilter">
              <template slot-scope="scope">
                {{ scope.row.marketingSceneType | getMarketingSceneTypeName}}
              </template>
            </el-table-column>
            <el-table-column
              align="center"
            ...
            <el-table-column
              ...
              :filter-method="handleMarketingSceneTypeFilter">
              <template slot-scope="scope">
                {{ scope.row.status| getMarketingSceneStatusName}}
              </template>
            </el-table-column>
            <el-table-column
              align="right"
              ...
              <template slot-scope="scope">
                ...
                <el-button type="text" size="small" @click="doDownloadQRCode(marketingSceneList[scope.$index])" v-if="marketingSceneList[scope.$index].marketingSceneType == 1">下载二维码</el-button>
                <el-button type="text" size="small" @click="doCreateSubQRCode(marketingSceneList[scope.$index].id)" v-if="false">生成子码</el-button>
                <el-popover
                  ref="popover"
                  placement="top"
                  width="200"
