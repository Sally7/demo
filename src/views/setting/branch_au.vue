<template>
  <div class="app-container" id="wrapper">
    ...
    <div class="app__content">
      <el-form :model="shop" :rules="rules" ref="shop" label-width="80px" class="form-content zj-trisect">
        <p class="form-title">基本信息</p>
        <el-form-item prop="name" label="门店名称">
          <el-input v-model="shop.name" ></el-input>
        </el-form-item>
        <el-form-item prop="groupNo" label="内部编号">
          <el-input v-model="shop.groupNo" ></el-input>
        </el-form-item>
        ...
        <el-form-item label="联系电话">
          <el-input v-model="shop.contact"></el-input>
        </el-form-item>
    ...
    <div class="footer">
      ...
      <el-button type="primary" @click="doAU('shop')" :loading="disabled">保存</el-button>
    </div>
