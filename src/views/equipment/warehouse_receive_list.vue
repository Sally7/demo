...
<template>
  <div class="app-container" id="wrapper">
    <div class="module-title" style="display: flex;justify-content: space-between">入库管理
    </div>
    <div class="app__content">
      <el-row :gutter="10">
        <el-button type="primary" size="small" @click="toAU()">新建入库</el-button>
      </el-row>
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <div class="goods-item-body">
              <div style="color: #909399">入库单号:{{scope.row.id}}</div>
