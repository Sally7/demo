...
<template>
  <div class="app-container" id="wrapper">
    <!--<div class="module-title" style="display: flex;justify-content: space-between">新建入库-->
    <!--</div>-->
    ...
    <div class="app__content">
      <div class="search-box">
        <el-form :model="model" :rules="rules" ref="modelForm">
          ...
          <el-form-item label="入库时间" label-width="80px" prop="equipmentDay">
            <el-date-picker
                style="width: 200px;"
                size="small"
          ...
          <el-form-item label="入库类型" label-width="80px" prop="outInWarehouse">
          ...
          <!--<el-form-item label="入库凭证" prop="https://splatformnew.oss-cn-shanghai.aliyuncs.com/file/673f22f20bbc11ebbd26d78d0ead4137.png@!1xx_l">-->
          <!--<el-upload-->
          <!--:action="uploadUrl"-->
          <!--:file-list="fileList"-->
          ...
          <!--</div>-->
          <!--</el-upload>-->
          <!--<p class="help-desc">请上传营业执照等资质文件，支持 png、jpg、jpeg 文件，单个文件不可大于 10m</p>-->
          <!--</el-form-item>-->
      ...
      <el-row>
        <el-col :span="24" class="text-left" style="padding-left: 10px;margin-top: 30px">
          ...
          <el-button plain size="small" type="primary" @click="show=true">选择入库装备</el-button>
    ...
    <el-dialog title="请选择入库装备" width="760px" height="80%" :visible="show" :before-close="handleClose">
      <el-row>
        <el-col>
  ...
  export default {
    data() {
      return {
        ...
        show: false,
        doAUing: false,
        expectDate: [{required: true, message: '请选择入库时间', trigger: 'change'}],
        outInWarehouseList: [
          {
            value: '4',
            label: '装备归还',
