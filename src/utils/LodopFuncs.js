...
//  oscript.src =process.env.BASE_API+"/CLodopfuncs.js?priority=1";
  head.insertBefore( oscript,head.firstChild );

  //引用双端口(8000和18000）避免其中某个被占用：
  oscript = document.createElement("script");
  oscript.src =process.env.BASE_API+"/CLodopfuncs.js?priority=0";
//  oscript.src ="http://192.168.10.156:8000/CLodopfuncs.js?priority=0";
  head.insertBefore( oscript,head.firstChild );
};
...
export function getLodop(oOBJECT,oEMBED){
  ...
  try{
    ...
    LODOP.SET_LICENSES("","4924F29A52B32BEC89BE99670FC728A0","C94CEE276DB2187AE6B65D56B3FC2848","");
    //===========================================================
    return LODOP;
